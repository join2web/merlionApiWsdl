...
class MerlionStructOrdersListResult extends MerlionWsdlClass
{
    ...
    /**
     * Set InvoiceNo value
     * @param string $_invoiceNo the InvoiceNo
     * @return string
     */
    public function setInvoiceNo($_invoiceNo)
    {
        return ($this->InvoiceNo = $_invoiceNo);
    }
    /**
