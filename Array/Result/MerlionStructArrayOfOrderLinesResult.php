<?php
/**
 * File for class MerlionStructArrayOfOrderLinesResult
 * @package Merlion
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MerlionStructArrayOfOrderLinesResult originally named ArrayOfOrderLinesResult
 ...
 * @date 2016-12-29
 */
class MerlionStructArrayOfOrderLinesResult extends MerlionWsdlClass
{
    /**
     * The item
     * Meta informations extracted from the WSDL
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var MerlionStructOrderLinesResult
     */
    public $item;
    /**
    ...
    /**
     * Get item value
     * @return MerlionStructOrderLinesResult|null
     */
    ...
    /**
     * Set item value
     * @param MerlionStructOrderLinesResult $_item the item
