<?php
/**
 * File for MerlionWsdlClass to communicate with SOAP service
 * @package Merlion
 ...
 */
/**
 * MerlionWsdlClass to communicate with SOAP service
 * 
 * @package Merlion
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-12-29
 */
class MerlionWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://api.merlion.com/dl/mlservice3?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses MerlionWsdlClass::setLastError()
     * @uses MerlionWsdlClass::initSoapClient()
     * @uses MerlionWsdlClass::initInternArrayToIterate()
     * @uses MerlionWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'MerlionWsdlClass'))
            {
     ...
     * @uses MerlionClassMap::classMap()
     * @uses MerlionWsdlClass::getDefaultWsdlOptions()
     * @uses MerlionWsdlClass::getSoapClientClassName()
     * @uses MerlionWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('MerlionClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = MerlionClassMap::classMap();
     ...
     * If a class is named as {Merlion}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('MerlionSoapClient') && is_subclass_of('MerlionSoapClient','SoapClient'))
            return 'MerlionSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses MerlionWsdlClass::WSDL_CACHE_WSDL
     * @uses MerlionWsdlClass::WSDL_COMPRESSION
     * @uses MerlionWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses MerlionWsdlClass::WSDL_ENCODING
     * @uses MerlionWsdlClass::WSDL_EXCEPTIONS
     * @uses MerlionWsdlClass::WSDL_FEATURES
     * @uses MerlionWsdlClass::WSDL_LOGIN
     * @uses MerlionWsdlClass::WSDL_PASSWORD
     * @uses MerlionWsdlClass::WSDL_SOAP_VERSION
     * @uses MerlionWsdlClass::WSDL_STREAM_CONTEXT
     * @uses MerlionWsdlClass::WSDL_TRACE
     * @uses MerlionWsdlClass::WSDL_TYPEMAP
     * @uses MerlionWsdlClass::WSDL_URL
     * @uses MerlionWsdlClass::VALUE_WSDL_URL
     * @uses MerlionWsdlClass::WSDL_USER_AGENT
     * @uses MerlionWsdlClass::WSDL_PROXY_HOST
     * @uses MerlionWsdlClass::WSDL_PROXY_PORT
     * @uses MerlionWsdlClass::WSDL_PROXY_LOGIN
     * @uses MerlionWsdlClass::WSDL_PROXY_PASSWORD
     * @uses MerlionWsdlClass::WSDL_LOCAL_CERT
     * @uses MerlionWsdlClass::WSDL_PASSPHRASE
     * @uses MerlionWsdlClass::WSDL_AUTHENTICATION
     * @uses MerlionWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses MerlionWsdlClass::getSoapClient()
     * @uses MerlionWsdlClass::getFormatedXml()
     ...
     * @uses MerlionWsdlClass::getSoapClient()
     * @uses MerlionWsdlClass::convertStringHeadersToArray()
     ...
     * @uses MerlionWsdlClass::getInternArrayToIterate()
     * @uses MerlionWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses MerlionWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses MerlionWsdlClass::getInternArrayToIterateOffset()
     * @uses MerlionWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses MerlionWsdlClass::getInternArrayToIterateOffset()
     * @uses MerlionWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see MerlionWsdlClass::offsetGet()
     * @uses MerlionWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses MerlionWsdlClass::getAttributeName()
     * @uses MerlionWsdlClass::__toString()
     * @uses MerlionWsdlClass::_set()
     * @uses MerlionWsdlClass::_get()
     * @uses MerlionWsdlClass::setInternArrayToIterate()
     * @uses MerlionWsdlClass::setInternArrayToIterateIsArray()
     * @uses MerlionWsdlClass::setInternArrayToIterateOffset()
