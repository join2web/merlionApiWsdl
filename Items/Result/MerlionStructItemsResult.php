...
class MerlionStructItemsResult extends MerlionWsdlClass
{
    ...
    public $Min_Packaged;
    /**
     * The Sales_Limit_Type
     * Meta informations extracted from the WSDL
     * - nillable : true
     * @var string
     */
    public $Sales_Limit_Type;
    /**
     * The GroupName1
     * Meta informations extracted from the WSDL
     * - nillable : true
     ...
     * @param string $_sales_Limit_Type
    ...
    /**
     * Set Sales_Limit_Type value
     * @param string $_sales_Limit_Type the Sales_Limit_Type
     * @return string
     */
    public function setSales_Limit_Type($_sales_Limit_Type)
    {
        return ($this->Sales_Limit_Type = $_sales_Limit_Type);
    }
    /**
