...
class MerlionStructItemsAvailResult extends MerlionWsdlClass
{
     ...
     * @var float
     */
    public $PriceClientRUB;
    /**
     * The PriceClientRUB_RG
     * Meta informations extracted from the WSDL
     * - nillable : true
     * @var float
     */
    public $PriceClientRUB_RG;
    /**
     * The PriceClientRUB_MSK
     * Meta informations extracted from the WSDL
     * - nillable : true
     * @var float
     */
    public $PriceClientRUB_MSK;
    /**
     * The Online_Reserve
     * Meta informations extracted from the WSDL
     * - nillable : true
    ...
    /**
     * Set PriceClientRUB value
     * @param float $_priceClientRUB the PriceClientRUB
     * @return float
     */
    public function setPriceClientRUB($_priceClientRUB)
    {
        return ($this->PriceClientRUB = $_priceClientRUB);
    }
    /**
     * Get PriceClientRUB_RG value
     * @return float|null
     */
    ...
    /**
     * Set PriceClientRUB_RG value
     * @param float $_priceClientRUB_RG the PriceClientRUB_RG
     * @return float
     */
    public function setPriceClientRUB_RG($_priceClientRUB_RG)
    {
        return ($this->PriceClientRUB_RG = $_priceClientRUB_RG);
    }
    /**
     * Get PriceClientRUB_MSK value
     * @return float|null
     */
    ...
    /**
     * Set PriceClientRUB_MSK value
     * @param float $_priceClientRUB_MSK the PriceClientRUB_MSK
     * @return float
     */
    public function setPriceClientRUB_MSK($_priceClientRUB_MSK)
    {
        return ($this->PriceClientRUB_MSK = $_priceClientRUB_MSK);
    }
    /**
