<?php
/**
 * File for class MerlionStructSetDeleteOrderCommand
 * @package Merlion
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MerlionStructSetDeleteOrderCommand originally named setDeleteOrderCommand
 ...
 * @date 2016-12-29
 */
class MerlionStructSetDeleteOrderCommand extends MerlionWsdlClass
{
    /**
     * The document_no
     * @var string
