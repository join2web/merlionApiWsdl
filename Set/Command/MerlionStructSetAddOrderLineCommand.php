<?php
/**
 * File for class MerlionStructSetAddOrderLineCommand
 * @package Merlion
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MerlionStructSetAddOrderLineCommand originally named setAddOrderLineCommand
 ...
 * @date 2016-12-29
 */
class MerlionStructSetAddOrderLineCommand extends MerlionWsdlClass
{
    /**
     * The document_no
     * @var string
    ...
    public $price;
    /**
     * Constructor method for setAddOrderLineCommand
     * @see parent::__construct()
     * @param string $_document_no
     * @param string $_item_no
     * @param int $_qty
     * @param float $_price
     * @return MerlionStructSetAddOrderLineCommand
     */
