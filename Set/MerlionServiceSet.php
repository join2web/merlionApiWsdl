...
{
    /**
     * Method to call the operation originally named setLinkedItems
     * Documentation : Обновление/вставка привязок товаров партнера к товарам Мерлиона
     * @uses MerlionWsdlClass::getSoapClient()
     * @uses MerlionWsdlClass::setResult()
     * @uses MerlionWsdlClass::saveLastError()
     * @param MerlionStructSetLinkedItems $_merlionStructSetLinkedItems
     * @return MerlionStructSetLinkedItemsResponse
     */
    public function setLinkedItems(MerlionStructSetLinkedItems $_merlionStructSetLinkedItems)
    {
        try
        {
            return $this->setResult(self::getSoapClient()->setLinkedItems($_merlionStructSetLinkedItems));
        }
     ...
     * @return MerlionStructSetAddOrderLineCommandResponse|MerlionStructSetDeleteOrderCommandResponse|MerlionStructSetLinkedItemsResponse|MerlionStructSetMoveOrderLineCommandResponse|MerlionStructSetOrderHeaderCommandResponse|MerlionStructSetOrderLineCommandResponse|MerlionStructSetSignOrderCommandResponse
     */
