...
class MerlionStructGetItemsAvail extends MerlionWsdlClass
{
    ...
    {
        parent::__construct(array('cat_id'=>$_cat_id,'shipment_method'=>$_shipment_method,'shipment_date'=>$_shipment_date,'only_avail'=>$_only_avail,'item_id'=>($_item_id instanceof MerlionStructArrayOfString)?$_item_id:new MerlionStructArrayOfString($_item_id)),false);
    }
    /**
     * Get cat_id value
     * @return string|null
